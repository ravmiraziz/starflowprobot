      ...
      {tabs.map((tab) => {
        ...
        return (
          <button
            ...
            className={`flex-1 relative py-2.5 rounded-full text-sm font-medium transition-colors duration-300 outline-none select-none ${isActive ? "text-black" : "text-white/60 hover:text-white"
              }`}
            style={{
