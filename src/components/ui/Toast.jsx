    ...
    <AnimatePresence>
      {toast.isVisible && (
        <motion.div
          ...
          className={`fixed mt-20 top-6 left-1/2 -translate-x-1/2 z-300 flex items-center gap-3 px-6 py-4 rounded-2xl backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.3)] border ${bgColors[toast.type] || bgColors.success} min-w-[300px] justify-center`}
        >
